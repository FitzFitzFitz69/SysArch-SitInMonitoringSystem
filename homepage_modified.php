...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <ul>
            ...
            <li><a href="#lab-schedule" onclick="showLabSchedule()"><i class="fa fa-calendar"></i> Lab Schedule</a></li>
            <?php } else { ?>
            ...
            <li><a href="#" onclick="showStudentLabSchedules(); return false;"><i class="fa fa-calendar-check-o"></i> Lab Schedules</a></li>
            <?php } ?>
        </ul>
